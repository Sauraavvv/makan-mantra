  ...
  return (
    <div className="w-full space-y-5">
      <form onSubmit={onSubmit} className="space-y-5">
        <div className="grid items-stretch gap-5 xl:grid-cols-[minmax(320px,0.72fr)_minmax(0,1.65fr)]">
        ...
        <div className="grid items-stretch gap-5 xl:grid-cols-2">
          ...
          <ProfileSection title="Account Email">
        ...
        <ProfileSection title="Location Details">
          <div className="grid gap-4 sm:grid-cols-2">
            <div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder={
                    preferredState.trim() ? "Select or enter city" : "Select state first"
                  }
                  autoComplete="off"
        ...
        <div className="flex flex-wrap items-center justify-end gap-3">
          <button
            ...
            className="inline-flex h-10 items-center gap-2 rounded-lg bg-saffron px-5 text-sm font-semibold text-saffron-foreground transition-opacity hover:opacity-90 disabled:opacity-60"
          >
